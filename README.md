...
Создайте тег для автоматического создания релиза:
```bash
git tag v1.0.0
git push origin v1.0.0
# Release будет создан автоматически через GitHub Actions
# Deployment можно запустить вручную из GitHub Actions UI
```
